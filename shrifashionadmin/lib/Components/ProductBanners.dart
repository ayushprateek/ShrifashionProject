...
import 'package:shrifashionadmin/Components/ProductImage.dart';

class ProductBanners extends StatefulWidget {

  var product_id;
  ProductBanners(var product_id) {
                    ...
                    try {
                      return ClipRRect(
                          ...
                          child: InkWell(
                            onTap: (){
                              //prod_image_id
                              Navigator.push(context, MaterialPageRoute(builder: (context)=>ProductImage(lists[i]['prod_image_id'])));
                            },
                            child: Image.network(
                              snap.data.image,
                              cacheWidth: 500,
