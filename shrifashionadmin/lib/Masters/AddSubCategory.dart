...
class AddSubCategory extends StatefulWidget {
  ...
  AddSubCategory({this.category_id,this.category_name});
  @override
...
class _AddSubCategoryState extends State<AddSubCategory> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Add Sub-category',style: TextStyle(color: Colors.black,fontFamily: custom_font),),
      ),
      body: ListView(
        children: [
          _imageFile != null
              ...
              child: Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Expanded(
                      child: Container(
                        child: Text(widget.category_name,style: new TextStyle(
                            fontFamily: "Poppins",
                            fontSize: 17
                        ),),
                      ),
  ...
  {
    subCategoriesLast.once().then(
            (DataSnapshot datasnapshot){
          Map<dynamic,dynamic> values= datasnapshot.value;
          values.forEach((key,value){
            int newKey=int.parse(key.toString())+1;
            subCategories.child(newKey.toString()).set({
              "category_id":newKey.toString(),
              "image":fileName.toString(),
              "name":name.text.toString(),
              "parent_id":widget.category_id.toString(),
              "parent_name":widget.category_name.toString(),
