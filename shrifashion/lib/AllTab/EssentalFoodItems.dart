...
class EssentialFoodItems extends StatefulWidget {
  @override
  _EssentialFoodItemsState createState() => _EssentialFoodItemsState();
}

class _EssentialFoodItemsState extends State<EssentialFoodItems> {
          ...
          if (snapshot.hasData) {
            ...
            try{
              ...
              values.forEach((values) {
                try{
                  if(values['status']=="True" && values['parent_id']=="59")
                    lists3.add(values);
                }
                catch(e)
                {
