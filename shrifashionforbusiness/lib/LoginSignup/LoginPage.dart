                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            //     onPressed: ()async{
                            //       // await register();
                            //       localStorage.setString("guest_id", "0");
                            //       PartnerDetails.partner_id="0";
                            //       PartnerDetails.store_id="0";
                            //       PartnerDetails.email="guest@shrifashionforbusiness.com";
                            //       PartnerDetails.name="Guest Account";
                            //
      ...
      try {
        ...
        custLast.once().then(
              ...
              values.forEach((key,value){
                ...
                localStorage.setString("guest_id", PartnerDetails.partner_id.toString());
              });
