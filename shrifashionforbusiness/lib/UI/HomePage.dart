...
import 'package:shrifashionforbusiness/Components/CustomDrawer.dart';
...
import 'package:shrifashionforbusiness/Masters/ProductDetails.dart';
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            StreamBuilder(
              stream: search.orderByChild("store_id").equalTo(PartnerDetails.store_id).onValue,
                    ...
                    return Column(
                      children: [
                        Padding(
                          ...
                          child: Container(
                            child: Text("Your Top 10 products",style: TextStyle(color: Colors.black,fontFamily: custom_font),),
                          ),
                        ),
                        GridView.builder(
                          physics: ScrollPhysics(),
                          itemCount: lists.length<=10?lists.length:10,
                          shrinkWrap: true,
                          gridDelegate:
                          ...
                          itemBuilder: (BuildContext context, index) {
                            ...
                            double margin=0.0;
                            double new_price=double.tryParse(lists[index]['new_price'].toString())??0.0;
                            double old_price=double.tryParse(lists[index]['old_price'].toString())??0.0;
                            margin=old_price-new_price;
                                  ...
                                  child: Container(
                                    ...
                                    child:  Column(
                                      children: [
                                        Expanded(
                                          child: Container(
                                            ...
                                            child: Align(
                                                ...
                                                child: IconButton(
                                                  icon: Icon(Icons.edit,color: Theme.of(context).buttonColor,),
                                                  onPressed: (){
                                                    print("Hello");

                                                    subCategories.orderByChild("category_id")
                                                        .equalTo(lists[index]['parent_id'])
                                              ...
                                              Expanded(
                                                  child: FittedBox(
                                                    child: Text("\u{20B9}"+double.parse(lists[index]['new_price']).toStringAsFixed(2),
                                                      style: TextStyle(color: Theme.of(context).buttonColor,fontSize: 15.0,
                                                        fontWeight: FontWeight.bold,),
                                                    ),
                                                  )),
                                              Expanded(
                                        ...
                                        Text(
                                          "Margin : \u{20b9}"+margin.toStringAsFixed(0),
                                          maxLines: 1,
                                          style: TextStyle(
