...
class _AddProductState extends State<AddProduct> {
  ...
  Future uploadImageToFirebase(BuildContext context) async {
    ...
    if(
    min_order_qty.text==null || min_order_qty.text==""
    ){
      hasUploaded=false;
      Fluttertoast.showToast(
          msg:
          "Minimum Order Quantity is mandatory!",
          toastLength: Toast
              .LENGTH_SHORT,
          gravity:
          ToastGravity
    ...
    if(
    old_price.text==null || old_price.text==""
    ){
      hasUploaded=false;
      Fluttertoast.showToast(
          msg:
          "Old Price is mandatory!",
          toastLength: Toast
              .LENGTH_SHORT,
          gravity:
          ToastGravity
  ...
  void addProduct(context)
  {
    ...
    searchLast.once().then(
          ...
          values.forEach((key,value){
            ...
            search.child(newKey.toString()).set({
              "store_id":PartnerDetails.store_id.toString(),
              "store_name":PartnerDetails.store_name.toString(),
              "product_id":product_id.toString(),
